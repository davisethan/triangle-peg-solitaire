...
export default (props) => {
  ...
  const history = [
    'Triangle Peg Solitaire is a board game for one player involving movement of marbles on a board with grooves. The game is simply known as Solitaire in the United Kingdom where the card games are called Patience. It is also referred to as Brainvita, especially in India.',
